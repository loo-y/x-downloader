...
from x_downloader import DownloadRequest, ResolveRequest, download_media, resolve_media

media = resolve_media(ResolveRequest(url="https://x.com/user/status/123"))
...
如果你不想在下载前交互选择分辨率，可以直接传：

```bash
xdl "https://missav.ws/cn/dass-648-chinese-subtitle" --quality high
```
